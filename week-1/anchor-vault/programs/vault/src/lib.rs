...
declare_id!("BfK74jPnSJryJEsCT8ZKVNASDypDAsmm1bJwBQRzsmHR");
...
// Stores bumps
// It is used so that we don't have to derive the program address again
// We can get it directly, it is a O(n) process
#[derive(InitSpace)]
#[account]
